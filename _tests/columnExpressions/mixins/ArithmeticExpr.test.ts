...
try {
    ...
    const projected = df.select([
        ...
        $df.col("val3").roundSigFigs(2).alias("roundSigFigs_2"),
        $df.col("val3").roundSigFigs(1).alias("roundSigFigs_1"),
    ...
    if (r0.roundSigFigs_2 !== -5.5) throw new Error(`roundSigFigs_2 failed: expected -5.5, got ${r0.roundSigFigs_2}`);
    if (r0.roundSigFigs_1 !== -6) throw new Error(`roundSigFigs_1 failed: expected -6, got ${r0.roundSigFigs_1}`);
    ...
    if (r1.roundSigFigs_2 !== 4.9) throw new Error(`roundSigFigs_2 failed: expected 4.9, got ${r1.roundSigFigs_2}`);
    if (r1.roundSigFigs_1 !== 5) throw new Error(`roundSigFigs_1 failed: expected 5, got ${r1.roundSigFigs_1}`);
