...
try {
    ...
    const dtDiffRows = diffDf.to_dicts() as any[];
    ...
    const dateDiffDf = df.with_columns(
    ...
    const dateDiffRows = dateDiffDf.to_dicts() as any[];
    ...
    const addDurDf = df.with_columns(
    ...
    const shiftedRows = addDurDf.to_dicts() as any[];
    ...
    const subDurDf = df.with_columns(
    ...
    const durAddDf = df.with_columns(
    ...
    const durRows = durAddDf.to_dicts() as any[];
    ...
    const durMulDf = df.with_columns(
    ...
    const tripledRows = durMulDf.to_dicts() as any[];
    ...
    const windowRes = windowDf.with_columns(
    ...
    const groupDf = windowDf.groupby("dept").agg(
        // Duration max/min/sum inside group_by
        $df.col("shift_dur").max().alias("max_shift"),
        $df.col("shift_dur").min().alias("min_shift"),
        // Datetime max inside group_by
        $df.col("start_dt").max().alias("latest_start"),
        // Comparison aggregation inside group_by (all truthy -> Boolean)
    ...
    const chainedDf = windowDf.with_columns(
    ...
    const conditionalDf = windowDf.with_columns(
    ...
    const multiBranchDf = windowDf.with_columns(
        $df.when($df.col("dept").eq("eng"))
            .then($df.col("end_dt").sub($df.col("start_dt")))
    ...
    const numericRes = numericDf.with_columns(
        // Int + Float => Float64
    ...
    const structRes = structDf.with_columns(
    ...
    const timeRes = timeDf.with_columns(
    ...
    const decRes = decDf.with_columns(
    ...
    const strRes = strDf.with_columns(
    ...
    const uintRes = uintDf.with_columns(
    ...
    const nestedArrRes = nestedArrDf.with_columns(
    ...
    const nullRes = nullDf.with_columns(
        $df.col("val").fill_null({ value: $df.col("fallback") }).alias("filled")
    );
    ...
    const intRankRes = intRankDf.with_columns(
    ...
    const uintRankRes = uintRankDf.with_columns(
    ...
    const floatRes = floatDf.with_columns(
    ...
    const objRes = objDf.with_columns(
    ...
    const numericArgRes = numericArgDf.with_columns(
    ...
    const numericArgRows = numericArgRes.to_dicts() as any[];
    ...
    const edgeTimeRes = edgeTimeDf.with_columns(
    ...
    const durDivDf = df.with_columns(
    ...
    const durDivRows = durDivDf.to_dicts() as any[];
    ...
    const mixedSignRes = mixedSignDf.with_columns(
    ...
    const edgeDecimalRes = edgeDecimalDf.with_columns(
    ...
    const edgeBinRes = edgeBinDf.with_columns(
    ...
    const deepExprDf = df.with_columns(
    ...
    const deepRows = deepExprDf.to_dicts() as any[];
    ...
    const boxedRes = boxedDf.with_columns(
    ...
    const typedArrRes = typedArrDf.with_columns(
    ...
    const arrLitRes = arrLitDf.with_columns(
    ...
    const bitwiseRes = bitwiseDf.with_columns(
    ...
    const decDurRes = decDurDf.with_columns(
    ...
    const complexStructRes = complexStructDf.with_columns(
    ...
    const mixedTemporalRes = mixedTemporalDf.with_columns(
    ...
    const rawArrRes = rawArrDf.with_columns(
    ...
    const deepNestRes = deepNestDf.with_columns(
    ...
    const mixedArrRes = mixedArrDf.with_columns(
    ...
    const exprArrRes = rawArrDf.with_columns(
    ...
    const noOtherwiseDf = rawArrDf.with_columns(
    ...
    const nullOtherwiseDf = rawArrDf.with_columns(
    ...
    const deepStructRes = deepStructDf.with_columns(
    ...
    const structFieldAliased = structDf.with_columns(
    ...
    const decimalScaleRes = decimalScaleDf.with_columns(
    ...
    const nestedWhenDf = rawArrDf.with_columns(
    ...
    const litBranchDf = litTestDf.with_columns(
    ...
    const largeIntDf = litTestDf.with_columns(
    ...
    const dateDurRes = dateDurDf.with_columns(
    ...
    const protoSafeRes = protoSafeDf.with_columns(
        $df.col("a").alias("b")
    );
    ...
    const u32Res = u32Df.with_columns(
    ...
    const branchNullDf = $df.data({
        ...
        $df.when($df.col("val").is_null()).then(null).otherwise($df.lit("fallback")).alias("cond_res"),
    ...
    const fallbackDf73 = $df.data({ a: [1] }).with_columns(
    ...
    const typedArrDf74 = $df.data({ dummy: [1] }).with_columns(
    ...
    const nestedArrDf75 = $df.data({ dummy: [1] }).with_columns(
    ...
    const objDf76 = $df.data({ dummy: [1] }).with_columns(
    ...
    const mixedBranchDf81 = $df.data({ flag: [true, false] }, { flag: $df.DataType.Boolean }).with_columns(
    ...
    const multiBranchWideningDf83 = $df.data({ step: [1, 2, 3] }, { step: $df.DataType.Int32 }).with_columns(
    ...
    const arrLitDf84 = $df.data({ id: [1] }).with_columns(
