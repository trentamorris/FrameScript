...
console.log("Running withRowIndex tests...");
...
const dictsIndex = dfIndex.toDicts() as any[];
...
const dfOverwrite = df.withRowIndex("name", 1);
...
const dictsOverwrite = dfOverwrite.toDicts() as any[];
...
console.log("✓ withRowIndex tests passed!");
